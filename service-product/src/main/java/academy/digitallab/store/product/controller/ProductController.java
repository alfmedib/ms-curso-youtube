...
// *********************** Crear un Producto ***************************
    ...
    public ResponseEntity<Product> createProduct(@Valid @RequestBody Product product, BindingResult result){
        ...
        Product creatPrdouc = productService.createProduct(product);

        return ResponseEntity.status(HttpStatus.CREATED).body(creatPrdouc);
 ...
 // *************** Formateo del messages de error ************************************
